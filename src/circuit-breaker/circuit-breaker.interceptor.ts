...
const DEFAULT_SUCCESS_THRESHOLD = 3; // Number of successful requests before closing the circuit
const DEFAULT_FAILURE_THRESHOLD = 3; // Number of failed requests before opening the circuit
const DEFAULT_OPEN_TO_HALF_OPEN_WAIT_TIME = 60000; // Time to wait before trying to reset the circuit (in milliseconds)
...
interface CircuitBreakerOptions {
  ...
  fallback?: () => Observable<any>; // Optional: fallback function when the circuit is open
}
