...
- **Gatilhos de Firestore/Realtime Database:** Quando um item é adicionado, atualizado ou removido do carrinho, uma Cloud Function pode ser acionada. Essa função pode então se conectar ao RabbitMQ e publicar uma mensagem (por exemplo, "item_adicionado", "carrinho_atualizado").
...
## Manual de uso caso em escolha o Firestore como database

- https://youtu.be/vW5NjulAAFY
